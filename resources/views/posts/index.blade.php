            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>Posts
                                <a href="{{route('posts.create')}}" class="btn btn-primary waves-effect waves-light float-end mb-4">Add Post</a>
                                <a href="{{route('showdeleted')}}" class="btn btn-danger waves-effect waves-light float-end mb-4">Recycle Bin</a>
                            </h4><br><br>
                            @if(session('message'))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('posts.destroy',$post->id)}}" method="POST" style="display: inline-block;">
                                                ...
                                                <button type="submit" onclick="return confirm('Are You Sure')" class="btn btn-danger waves-effect waves-light">SoftDelete</button>
                                            </form>

                                            <a href="{{route('posts.edit',$post->id)}}" class="btn btn-warning waves-effect waves-light">Edit</a>
